...
document.querySelectorAll('.dropdown-toggle').forEach(function (dropdownToggle) {
  dropdownToggle.addEventListener('click', function (e) {
    ...
    e.preventDefault();
    var dropdownParent = this.parentElement; // Obtener el contenedor del menú clicado
    var dropdownMenu = this.nextElementSibling; // Obtener el submenú relacionado
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkbootstrapmegamenu"] = self["webpackChunkbootstrapmegamenu"] || [];
